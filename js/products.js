...
const PRODUCTS = [
  ...
  { id: 2,  name: "Rani Pink Raga",      collection: "Bridal",   color: "Rani Pink",         price: 599, image: "images/bangle2.jpeg",  description: "Deep rani pink thread wrapped in a traditional raga pattern, studded with kundan stones. Designed for the bride who wants colour without losing elegance." },
  { id: 3,  name: "Peacock Teal Weave",  collection: "Casual",   color: "Peacock Teal",      price: 379, image: "images/bangle3.jpeg",  description: "A cool peacock-teal weave with a matte thread finish, perfect for everyday wear over kurtas and cottons." },
  { id: 4,  name: "Emerald Zari Coil",   collection: "Festive",  color: "Emerald Green",     price: 529, image: "images/bangle4.jpeg",  description: "Emerald silk thread coiled with fine zari edging, giving each bangle a subtle metallic glint under light." },
  { id: 5,  name: "Sunset Kundan",       collection: "Bridal",   color: "Sunset Orange",     price: 649, image: "images/bangle5.jpeg",  description: "Warm sunset-orange thread paired with hand-set kundan stones along the outer edge. A statement piece for evening functions." },
  { id: 6,  name: "Ivory Pearl Trail",   collection: "Bridal",   color: "Ivory White",       price: 599, image: "images/bangle6.jpeg",  description: "Ivory thread base trailed with tiny seed pearls, designed to sit quietly elegant against darker outfits." },
